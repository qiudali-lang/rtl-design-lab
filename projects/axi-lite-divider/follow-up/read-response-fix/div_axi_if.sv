// Public portfolio revision: registered AXI read response. Historical PPA belongs to the original revision.
module div_axi_if (
  ...
  always_ff @(posedge s_axi_clk) begin
    if (!s_axi_resetn) begin
      ...
      if (s_axi_arready && s_axi_arvalid) begin
        // Portfolio revision: snapshot at AR handshake, hold through R stalls.
